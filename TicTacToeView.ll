; ModuleID = 'Game/TicTacToeView.cpp'
...
@.str = private unnamed_addr constant [8 x i8] c"  0 1 2\00", align 1
...
@_ZTV13TicTacToeView = unnamed_addr constant [3 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI13TicTacToeView to i8*), i8* bitcast (void (%class.TicTacToeView*, %"class.std::basic_ostream"*)* @_ZNK13TicTacToeView10PrintBoardERSo to i8*)]
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS13TicTacToeView = constant [16 x i8] c"13TicTacToeView\00"
...
@_ZTI13TicTacToeView = constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i32 2) to i8*), i8* getelementptr inbounds ([16 x i8]* @_ZTS13TicTacToeView, i32 0, i32 0), i8* bitcast ({ i8*, i8* }* @_ZTI8GameView to i8*) }
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_TicTacToeView.cpp, i8* null }]
...
define void @_ZNK13TicTacToeView10PrintBoardERSo(%class.TicTacToeView* %this, %"class.std::basic_ostream"* dereferenceable(140) %s) unnamed_addr #0 align 2 {
  ...
  %5 = call dereferenceable(140) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(140) %4, i8* getelementptr inbounds ([8 x i8]* @.str, i32 0, i32 0))
...
; <label>:20                                      ; preds = %17
  ...
  %23 = getelementptr inbounds %class.TicTacToeView* %3, i32 0, i32 1
  %24 = load %class.TicTacToeBoard** %23, align 4
  %25 = getelementptr inbounds %class.TicTacToeBoard* %24, i32 0, i32 1
  %26 = getelementptr inbounds [3 x [3 x i32]]* %25, i32 0, i32 %22
  %27 = getelementptr inbounds [3 x i32]* %26, i32 0, i32 %21
...
; <label>:34                                      ; preds = %20
  ...
  %37 = getelementptr inbounds %class.TicTacToeView* %3, i32 0, i32 1
  %38 = load %class.TicTacToeBoard** %37, align 4
  %39 = getelementptr inbounds %class.TicTacToeBoard* %38, i32 0, i32 1
  %40 = getelementptr inbounds [3 x [3 x i32]]* %39, i32 0, i32 %36
  %41 = getelementptr inbounds [3 x i32]* %40, i32 0, i32 %35
...
; <label>:48                                      ; preds = %34
  ...
  %51 = getelementptr inbounds %class.TicTacToeView* %3, i32 0, i32 1
  %52 = load %class.TicTacToeBoard** %51, align 4
  %53 = getelementptr inbounds %class.TicTacToeBoard* %52, i32 0, i32 1
  %54 = getelementptr inbounds [3 x [3 x i32]]* %53, i32 0, i32 %50
  %55 = getelementptr inbounds [3 x i32]* %54, i32 0, i32 %49
...
define internal void @_GLOBAL__sub_I_TicTacToeView.cpp() section ".text.startup" {
